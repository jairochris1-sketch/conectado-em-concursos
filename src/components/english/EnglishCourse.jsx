  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <motion.div 
        ...
        className="mb-8"
      >
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white shadow-xl relative">
          ...
          <Card className="bg-gradient-to-br from-blue-500 to-indigo-600 text-white border-0 shadow-lg">
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-blue-100">Lições Completas</p>
                  <p className="text-3xl font-bold">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {lessons.map((lesson) => {
          ...
          return (
            ...
            >
              <Card className="cursor-pointer hover:shadow-2xl transition-all border-2 border-transparent hover:border-blue-400 overflow-hidden">
                <div className={`h-2 ${isCompleted ? 'bg-gradient-to-r from-green-400 to-emerald-500' : 'bg-gradient-to-r from-blue-400 to-indigo-500'}`} />
                <CardHeader>
                  <div className="flex items-center justify-between mb-2">
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 p-2 rounded-lg">
                      ...
                      <span className="font-medium">{lesson.words?.length || 0} palavras</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 p-2 rounded-lg">
                    ...
                    {lessonProgress && (
                      <div className="pt-2 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-3 rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                    ...
                    <Button
                      ...
                      className={`w-full mt-2 font-semibold ${isCompleted ? 'bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700' : 'bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700'}`}
                      size="lg"
                    >
