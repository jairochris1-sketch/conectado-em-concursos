    ...
    <AnimatePresence>
      <motion.div
        ...
        <div className="relative">
          ...
          <div className="bg-blue-500 p-4 rounded-2xl relative shadow-2xl w-[260px] border backdrop-blur-sm from-blue-500 via-indigo-500 to-purple-500 border-blue-300/50">
