...
import { Trophy, Flame, Target, Star, ChevronUp, ChevronDown, Minus } from "lucide-react";
...
export default function RankingPage() {
  ...
  // Pódio: exibir 2º, 1º, 3º (centro primeiro)
              ...
              {podiumOrder.map((rankIdx) => {
                ...
                return (
                  <div key={r.id} className={`flex flex-col items-center ${isCenter ? "scale-105" : ""}`}>
                    ...
                    <div
                      className={`w-full mt-2 rounded-t-lg bg-gradient-to-b ${MEDAL_GRADIENTS[rankIdx]} ${podiumHeights[rankIdx]} opacity-30 min-w-[72px]`}
                    />
                  </div>
                );
              })}
